...
This module provides the transformation logic for construction plane relationships.

Classes:
    - ConstructionElementsTransformer: A class to handle construction plane-based transformations.
"""
import traceback
...
class ConstructionElementsTransformer(BaseTransformer):
    ...
    Methods:
        transform(execute_query): Runs all construction plane-related transformation methods.
    """
    def transform(self, execute_query):
        ...
        """
        results = {}
        results['create_construction_planes_relationships'] = self.create_construction_planes_relationships(execute_query)
        results['create_feature_to_axes_bodies_extents_relationships'] = self.create_feature_to_axes_bodies_extents_relationships(execute_query)
        return results
    ...
    def create_feature_to_axes_bodies_extents_relationships(self, execute_query):
        """
